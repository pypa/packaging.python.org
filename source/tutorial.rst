...
#. Use an external build tool that either manages updating both locations, or
   ...
   Example ``.bumpversion.cfg`` (for use with `bumpversion <https://pypi.python.org/pypi/bumpversion>`_)::
    
      [bumpversion]
      current_version = 0.1.0
      files = setup.py package/__init__.py

   There alternative tools that can manage versions: 
   `changes <https://pypi.python.org/pypi/changes>`_, 
...
Other alternatives which you might see in the wild, but which you should not replicate:
